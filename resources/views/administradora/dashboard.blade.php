...
<div class="container vh-100">
  <h2 class="my-4 text-secondary">Olá, {{ $user->name }}. Seja muito bem vindo! <br> Aqui você escolhe a movimentação e em seguida <br>  o sistema irá redireciona-lo para a tela das propostas.</h2>
